    ...
    prew.innerHTML = `
       ...
       <div class="card mb-3 border-0">
          <div class="row g-0 my-auto border-radius-black">
              <div class="col-6">
                <img src="${ImageProduct.value}" class="card-img-top border-radius" alt="..." style="height: 100%; aspect-ratio: 0.8; object-fit: cover;">
              </div>
              <div class="col-6">
                  <div class="card-body d-flex flex-column" style= "height: 100%;">
                      ...
                      <p class="card-text my-auto pt-2" style= "max-height: 200px; overflow: auto;">${DescriptionProduct.value}</p>
                  </div>
              </div>
           </div>
        </div>
